...
use Presta_Shop\Presta_Shop\Core\Domain\Tax\Command\Bulk_Toggle_Tax_Status_Command;
...
#[Api_Resource(operations: [new Cqrs_Update(
    ...
    // No output 204 code
    output: false,
    CQRSCommand: Bulk_Toggle_Tax_Status_Command::class,
    CQRSCommandMapping: ['[enabled]' => '[expectedStatus]'],
    scopes: ['tax_write']
)])]
class Bulk_Tax_Toggle_Status
{
    /**
     * @var int[]
     */
